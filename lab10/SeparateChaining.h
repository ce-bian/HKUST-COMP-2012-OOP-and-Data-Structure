...
public:
	...
	bool clearData();							 //TODO: Implement the function that clear the hash table; just return true after deletion; you may return false if the data is already deleted when this function is called
